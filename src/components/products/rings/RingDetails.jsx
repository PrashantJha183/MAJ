...
// You can replace this with an actual icon/image path for 916 Hallmark
...
const RingDetails = memo(() => {
  ...
  // Toggle between Description and Pricing
                ...
                >
                  <tbody>
                    ...
                    <tr className="border-b">
                      ...
                      <td className="py-2">
                        <div className="flex flex-col items-end gap-0 md:flex-row md:items-end md:justify-end md:gap-2">
                          <img
                            src={Hm916Icon}
                            alt="916 Hallmark"
