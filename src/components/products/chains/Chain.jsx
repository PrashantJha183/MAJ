// components/pages/Jewellery/Chain.jsx
import React, { useEffect, useState, useRef } from "react";
import { motion, AnimatePresence } from "framer-motion";
import { useNavigate } from "react-router-dom";
import Chain1 from "../../../assets/DSC_9085.JPG"; // fallback image
...
export default function Chain() {
  ...
  const handleCardClick = (chain) => {
    navigate("/chains/details", { state: { chain } });
  };
    ...
    <div className="px-6 pt-12 pb-8 md:pt-32 md:pb-20 new-font">
      ...
      >
        {chainsData.map((chain, i) => {
          const images = chain.images?.length ? chain.images : [Chain1];
          ...
          const calculatedPrice =
            goldPricePerGram && chain.netWeight
              ? Math.round(chain.netWeight * goldPricePerGram * 1.18 * 1.03)
              : null;
