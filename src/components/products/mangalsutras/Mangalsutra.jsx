// components/pages/Jewellery/Mangalsutra.jsx
import React, { useEffect, useState, useRef } from "react";
import { motion, AnimatePresence } from "framer-motion";
import { useNavigate } from "react-router-dom";
import Mangalsutra1 from "../../../assets/DSC_9085.JPG"; // fallback image
import mangalsutrasData from "./Mangalsutras.json";
...
export default function Mangalsutra() {
  ...
  const handleCardClick = (mangalsutra) => {
    navigate("/mangalsutras/details", { state: { mangalsutra } });
  };
  ...
  return (
    <div className="px-6 pt-12 pb-8 md:pt-32 md:pb-20 new-font">
      ...
      >
        {mangalsutrasData.map((mangalsutra, i) => {
          const images = mangalsutra.images?.length
            ? mangalsutra.images
            : [Mangalsutra1];
          ...
          const calculatedPrice =
            goldPricePerGram && mangalsutra.netWeight
              ? Math.round(
                  mangalsutra.netWeight * goldPricePerGram * 1.18 * 1.03
                )
              : null;
          ...
          return (
            <motion.div
              ...
              onClick={() => handleCardClick(mangalsutra)}
            >
              <motion.div
              ...
              >
                <AnimatePresence mode="wait">
                  <BlurOverlayImage
                    src={src}
                    alt={mangalsutra.name || "Jewellery Item"}
                    isFailed={isFailed}
