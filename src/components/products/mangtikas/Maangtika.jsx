// components/pages/Jewellery/Maangtika.jsx
import React, { useEffect, useState, useRef } from "react";
import { motion, AnimatePresence } from "framer-motion";
import { useNavigate } from "react-router-dom";
import Maangtika1 from "../../../assets/DSC_9085.JPG"; // fallback image
import maangtikasData from "./Maangtikas.json";
...
export default function Maangtika() {
  ...
  const handleCardClick = (maangtika) => {
    navigate("/maangtikas/details", { state: { maangtika } });
  };
  ...
  return (
    <div className="px-6 pt-12 pb-8 md:pt-32 md:pb-20 new-font">
      ...
      >
        {maangtikasData.map((maangtika, i) => {
          const images = maangtika.images?.length
            ? maangtika.images
            : [Maangtika1];
          ...
          const calculatedPrice =
            goldPricePerGram && maangtika.netWeight
              ? Math.round(maangtika.netWeight * goldPricePerGram * 1.18 * 1.03)
              : null;
          ...
          return (
            <motion.div
              ...
              onClick={() => handleCardClick(maangtika)}
            >
              <motion.div
              ...
              >
                <AnimatePresence mode="wait">
                  <BlurOverlayImage
                    src={src}
                    alt={maangtika.name || "Jewellery Item"}
                    isFailed={isFailed}
